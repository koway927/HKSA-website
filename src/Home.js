        ...
        <div className="Home">
            ...
            <div className="club-about">
                    ...
                    <p id = "about-text">
                        ...
                        at the University of Illinois at Urbana-Champaign (UIUC HKSA). We are committed to spread awareness, 
            ...
            <div className="club-contact">
                ...
                <div id = "home-icon-container">
                    ...
                    <a id = "home-instagram-icon-link" target="_blank" href="https://www.instagram.com/uiuc.hksa/?utm_source=ig_web_button_share_sheet&igsh=OGQ5ZDc2ODk2ZA%3D%3D">
                            <FaInstagram className = "home-social-icon" size={50}></FaInstagram>
                    </a>
                    <a id = "home-discord-icon-link" target="_blank" href="https://discord.gg/BC5FEnGCYs">
                            <FaDiscord className = "home-social-icon" size={50}></FaDiscord>
                    </a>
                    <a id = "home-newsletter-icon-link" target="_blank" href="https://gmail.us8.list-manage.com/subscribe?u=34595721dc9c61017bba4ffcd&id=1a25ff137d">
